...
public class NewEditController {
    ...
    private static final Logger LOGGER = Logger.getLogger(NewEditController.class.getName());
    ...
    public void initialize() {
        LOGGER.info("new/edit window initializing");
//        switch (clickedButton.getId()){
    ...
    private Task collectFieldsData() {
        ...
        try {
            ...
            try {
                ...
                LOGGER.error("error loading field-validator.fxml");
            }
        }
        return result;
    }
